...
# Modificar valor default do HOST e USER
text = re.sub(r'<input\s+type="text"\s+id="simDbHost"[^>]*>', '<input type="text" id="simDbHost" class="form-control" value="10.10.100.4">', text)
text = re.sub(r'<input\s+type="text"\s+id="simDbUser"[^>]*>', '<input type="text" id="simDbUser" class="form-control" value="intranet_user">', text)
...
# Inserir o script JS clearSimData
js_script = '''
